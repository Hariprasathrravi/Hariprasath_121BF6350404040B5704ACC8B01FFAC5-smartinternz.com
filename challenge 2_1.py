...
class bankaccount:
    def __init__(self,account_number,holder_name,balance):
        ...
        print("WELCOME")
        print("Account Number:{}   Account Holdername:{} \n Account balance:{}".format(self._account_number,self._holder_name,self._balance))

    def deposit(self,amount):
        if amount>0:
            self._balance+=amount
            print("\n\nDeposited:")
            print("Account Number:{}   Deposited amount:{} \nAccount Balance:{}".format(self._account_number,amount,self._balance))
        else:
    ...
    def check_balance(self):
        print("\nBalance")
        print("The account number:{}The account holder name:{}The account balance:{}".format(self._account_number,self._holder_name,self._balance))
...
s=bankaccount(123456789,"Hariprasath",0.0)
